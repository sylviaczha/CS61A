...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        ATT = other_card.attack
        DEF = other_card.defense
        other_card.attack = DEF
        other_card.defense = ATT
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for i in range(len(copy)):
            if copy[i].attack == other_card.attack or \
                    copy[i].defense == other_card.defense:
                res.append(i)
        res.reverse()
        for i in res:
